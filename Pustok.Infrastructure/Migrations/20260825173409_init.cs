        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Slider_Price_Not_Negative", "[Price]>0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingStar = table.Column<decimal>(type: "decimal(2,1)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Product_Discount_Range", "[Discount]>=0 AND [Discount]<=100");
                    table.CheckConstraint("CK_Product_Price_Not_Negative", "[Price]>0");
                    table.CheckConstraint("CK_Product_RatingStar_Range", "[RatingStar]>0 AND [RatingStar]<=5");
                    table.CheckConstraint("CK_Product_Stock_Positive", "[Stock]>=0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_BasketItem_Count_Not_Negative", "[Count]>0");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "SupportNumber", "+1234567" },
                    { 2, "Address", "ExampleAddress" },
                    { 3, "Phone", "+2121212" },
